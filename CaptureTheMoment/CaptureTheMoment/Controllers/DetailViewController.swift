...
final class DetailViewController: UIViewController {
    ...
    private func configureUI() {
        ...
        [imageViewer, commentLabel].forEach {
            view.addSubview($0)
        ...
        [
            ...
            commentLabel.topAnchor.constraint(equalTo: imageViewer.bottomAnchor, constant: spacing * 3),
            commentLabel.widthAnchor.constraint(equalToConstant: view.bounds.width - spacing * 2),
